...
const ImageWithDescriptions = () => {
  ...
  console.log(booklet)
  return (
    <Grid  container direction="column" alignItems="center" sx={{ minHeight: '210px',fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <Box sx={{ width: '100%', height: '210px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', overflow: 'hidden', backgroundColor: '#F1F5F9', m: "1px", pt: "15px", }} >
        ...
        <Box sx={{ mt: 1, color: '#FF0000', m: "1px",  fontWeight: '500'}}
        >{booklet.abbreviation}</Box>
        
        <Box sx={{ mt: 1, color: '#999999', m: "0px", pb: "15px", fontWeight: '600'}}
        >{booklet.name}</Box>
      </Box>
