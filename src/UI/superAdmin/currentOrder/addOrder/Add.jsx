      ...
      {isLoadingModalSave ? (
        ...
        <>
          ...
          {products[0]?.productTypeId === 4 ? (
                  ...
                  <>
                  <Grid container sx={{ borderBottom: '2px solid #005475', zIndex: 100, height: '40px', position: 'fixed', top: '0', bottom: '0', left: '0', right: '0', mt: '305px',justifyContent:'center' }}>
                    <Box sx={{fontFamily: "Montserrat",
                              fontSize: "16px",
                              fontWeight:'400', }}
                              onClick={() => handleChangeOpenModalProduct()}>
                      Добавить товар
                      <IconButton>
