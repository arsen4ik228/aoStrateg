              ...
              <>
                ...
                {listModalTitles[0]?.product.abbreviation == "Д" ? (
                  <>
                    <>
                      ...
                      {element.status === "Активный" ||
                        ...
                        <Grid sx={{ width: '100%', zIndex: 1, overflow: 'auto', mt: '315px', height: 'calc(100vh - 400px)', position: 'fixed', overflow: 'auto',borderTop: '2px solid #B4B4B4' }}>
                          {listModalTitles.map((row) => (
                            <Box key={row.id}>
                              <Grid container sx={{ justifyContent: 'center', alignItems: 'center', justifyContent: 'center', borderBottom: '2px solid #005475', }} >
                                <Box
                  ...
                  <>
                    ...
                    <Box onClick={() => handleChangeModalUpdate()} sx={{fontWeight:400, fontFamily: "'Montserrat', sans-serif", fontSize: '16px'}}>
                      Добавить товар
                      <IconButton >
                            ...
                            return (
                              <Box key={row.id}>
                                ...
                                <Grid container sx={{ height: '50px', color: 'black', fontFamily: "'Montserrat', sans-serif",  }} >
                                  ...
                                  <Grid container sx={{ justifyContent: 'center', alignItems: 'center',height: '50px', color: 'black', fontFamily: "'Montserrat', sans-serif", borderBottom: '1px solid #B4B4B4'  }}>
                                  <Box sx={{ color: '#005475' }} onClick={() =>
                                    handleDeleteOrder(
                                      element.id,
                                      row.id,
                      ...
                      <Grid sx={{ width: '100%', zIndex: 1, overflow: 'auto', mt: '309px', height: 'calc(100vh - 285px)', position: 'fixed', overflow: 'auto',borderTop: '2px solid #005475' }}>
                        {listModalTitles.map((row) => (
                          <Box key={row.id}>
                            <Grid container sx={{ height: '50px', color: 'black', fontFamily: "'Montserrat', sans-serif" }} >
                              <Grid container item xs={6} sx={{ justifyContent: 'flex-start', alignItems: 'center' }} >
